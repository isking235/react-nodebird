...
const reducer = (state = initialState, action) => produce(state, (draft) => {
        switch (action.type) {
            ...
            case LOAD_FOLLOWINGS_REQUEST:
                draft.loadFollwingLoading =  true;
                draft.loadFollwingError  = null;
                draft.loadFollwingDone =  false;
                break;

            case LOAD_FOLLOWINGS_SUCCESS:
                draft.loadFollwingLoading =  false;
                draft.me.Followings = action.data;
                draft.loadFollwingDone =  true;
                break;

            case LOAD_FOLLOWINGS_FAILURE:
                draft.loadFollwingLoading =  false;
                draft.loadFollwingError =  action.error;
                break;
